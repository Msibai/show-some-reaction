    ...
    return (
        <>
            ...
            <form onSubmit={handleSubmit} className="login-form">
                ...
                <input value={email} onChange={(e => setEmail(e.target.value))} type="email" placeholder="youremail@gmail.com" id="email" name="email" className="email" />
                <label className="pass-label"htmlFor="password">Password</label>
            <div className="pass-eye-div">
                <input value={pass} onChange={(e => setPass(e.target.value))} type={type} placeholder="*************" id="password" name="password" className="password" />
